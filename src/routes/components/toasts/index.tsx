      ...
      <div className="bg-white border-4 border-border p-8 md:p-12 mb-8">
        ...
        <Flex wrap gap={4}>
          ...
          <Button
            ...
            data-toast-message="Something went wrong. Try again."
            size="sm"
            className="px-6"
          >
            Show Error
          ...
          <Button
            ...
            data-toast-title="Heads up"
            data-toast-message="A new version is available."
            size="sm"
            className="px-6"
          >
            Show Info
          ...
          <Button
            ...
            data-toast-message="Your session will expire soon."
            size="sm"
            className="px-6"
          >
            Show Warning
      ...
      <div className="bg-white border-4 border-border p-8 md:p-12 mb-8">
        ...
        <div className="grid grid-cols-2 gap-4 max-w-sm">
          <Button
            ...
            data-toast-trigger
            data-toast-variant="info"
            data-toast-message="Top left toast"
          ...
          <Button
            ...
            data-toast-trigger
            data-toast-variant="info"
            data-toast-message="Top right toast"
          ...
          <Button
            ...
            data-toast-trigger
            data-toast-variant="info"
            data-toast-message="Bottom left toast"
          ...
          <Button
            ...
            data-toast-trigger
            data-toast-variant="info"
            data-toast-message="Bottom right toast"
