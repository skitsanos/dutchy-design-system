    ...
    >
      <Flex className="min-h-screen">
        ...
        <Sidebar
          ...
          bottomItems={[{ icon: 'settings', label: 'Settings', href: '#' }]}
        ...
        <Flex direction="col" className="flex-1">
            ...
            <div className="bg-background border-l-4 border-foreground p-4 mb-6">
              ...
              <Flex wrap gap={2}>
                ...
                <Button
                  ...
                  data-toast-message="Something went wrong."
                >
                  Error
                </Button>
                <Button
                  ...
                  data-toast-message="New update available."
                >
                  Info
                </Button>
                <Button
                  ...
                  data-toast-message="Low disk space warning."
                >
                  Warning
                </Button>
              </Flex>
                              ...
                              <Flex gap={1} className="ml-4">
                                ...
                                <Tooltip text="Delete">
                                  <Button
                                    ...
                                    icon
                                    size="sm"
                                    className="w-auto h-auto p-1 hover:text-destructive"
                                  >
                ...
                },
                {
                  ...
                  content: (
                    <>
                      ...
                      <div className="space-y-2">
                        {notifications
                          .filter((n) => n.tabGroup.includes('unread'))
                          .map((notif) => (
                            <div
                              key={notif.id}
                              className="notif-item bg-background border-l-4 p-4 cursor-pointer hover:bg-muted/30 transition-colors"
          ...
          <footer className="bg-foreground text-background py-4 px-6">
            <p className="font-mono text-xs opacity-60 uppercase tracking-widest text-center">
      ...
      <Drawer id="preferences-drawer" title="Preferences" position="right">
        <div className="space-y-6">
          <div>
            <h4 className="font-display font-bold uppercase text-sm tracking-wider mb-3">
              Email Notifications
            </h4>
        ...
        <div className="border-t border-border mt-6 pt-4">
          <Button fullWidth data-drawer-close="">
            Save Preferences
          </Button>
        </div>
      </Drawer>
