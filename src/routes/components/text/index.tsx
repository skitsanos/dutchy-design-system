        ...
        <div className="space-y-8 max-w-2xl">
          ...
          <div>
            ...
            <Text size="base" leading="relaxed">
              ...
              readability. This creates comfortable reading for longer content blocks and ensures
              the text remains clear and legible.
            </Text>
          </div>
      ...
      <div className="bg-white border-4 border-border p-8 md:p-12 mb-8">
        ...
        <div className="space-y-4 max-w-2xl">
          <div className="bg-muted p-4">
            <Text family="mono" size="xs" color="muted" className="mb-1">
              as="h1"
            </Text>
            <Text family="display" size="3xl" weight="bold" uppercase tracking="tighter" as="h1">
              Rendered as h1
            </Text>
          </div>
          <div className="bg-muted p-4">
            ...
            <Text family="display" size="2xl" weight="bold" uppercase as="h2">
              Rendered as h2
            </Text>
          </div>
          <div className="bg-muted p-4">
            ...
            <p>
              ...
              <Text family="display" weight="bold" uppercase color="primary" as="span">
                inline styled text
              </Text>{' '}
              within it.
            </p>
          ...
          <div className="bg-muted p-4">
            ...
            <Text family="mono" size="sm" weight="bold" uppercase tracking="wider" as="label">
              Form Field Label
            </Text>
          </div>
        </div>
          ...
          <div className="bg-foreground p-4 mt-4">
            <Flex align="center" gap={4}>
              <Text
                ...
                uppercase
                tracking="wider"
                className="w-28 shrink-0 text-background/60"
              >
                background
              </Text>
              <Text
