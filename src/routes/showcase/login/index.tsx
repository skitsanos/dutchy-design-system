        ...
        >
          ...
          <div className="relative z-10">
            ...
            <p className="text-xl text-background/70 max-w-md leading-relaxed">
              Access 50+ professionally crafted components and start building your next project
              today.
            </p>
          </div>
              ...
              <Form action="/showcase/login" method="POST" spacing="md">
                ...
                <div>
                  <Flex align="center" justify="between" className="mb-2">
                    ...
                    <a
                      href="#"
                      className="text-sm text-primary hover:underline decoration-2 underline-offset-2"
                    >
                      Forgot?
                    </a>
                  </Flex>
