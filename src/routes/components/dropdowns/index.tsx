...
const DropdownsPage: FC = () => (
  <ComponentPageLayout componentId="dropdowns">
    <>
      <Flex wrap gap={8} align="start">
        ...
        <div>
          ...
          >
            ...
            <MenuItem icon={<Icon name="copy" size="sm" />} className="border-t border-border">
              Duplicate
            </MenuItem>
            <MenuItem icon={<Icon name="archive" size="sm" />} className="border-t border-border">
              Archive
            </MenuItem>
          </Dropdown>
        </div>
        ...
        <div>
          ...
          <Button
            variant="outline"
            data-open-modal="command-palette"
            size="sm"
            className="px-6 border-border hover:border-foreground"
          >
            <Icon name="search" size="sm" />
            Search...
            <kbd className="ml-2 text-xs font-mono text-muted-foreground bg-muted px-2 py-0.5 border border-border">
              Ctrl+K
            </kbd>
          </Button>
        </div>
      ...
      <dialog
        id="command-palette"
        className="bg-background border-4 border-border p-0 w-full max-w-lg backdrop:bg-foreground/50"
      >
        ...
        <div className="max-h-80 overflow-auto">
          ...
          <MenuItem icon={<Icon name="home" size="sm" />} shortcut="G H">
            Home
          </MenuItem>
          <MenuItem
          ...
          <MenuItem icon={<Icon name="plus" size="sm" />} shortcut="Ctrl+N" data-close-modal>
            Create New...
          </MenuItem>
        </div>
      </dialog>
