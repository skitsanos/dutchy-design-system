        ...
        <nav aria-label="Breadcrumb demo 3">
          <ol className="flex items-center gap-2 text-sm">
            <li>
              <a
                href="#breadcrumbs"
                className="font-bold uppercase tracking-wide text-muted-foreground hover:text-primary transition-colors"
              >
                Home
              </a>
            </li>
            ...
            <li>
              <button
                type="button"
                className="inline-flex items-center border-2 border-border px-2 py-0.5 font-bold text-muted-foreground hover:border-primary hover:text-primary transition-colors"
            ...
            <li className="font-bold uppercase tracking-wide" aria-current="page">
              Product Detail
            </li>
          </ol>
        </nav>
