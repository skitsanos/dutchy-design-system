  ...
  <ComponentPageLayout componentId="image">
    <>
      ...
      <div className="bg-white border-4 border-border p-8 md:p-12 mb-8">
        ...
        <Image src="https://picsum.photos/seed/dutchy-basic/800/450" alt="Landscape photograph" />
      </div>
      ...
      <div className="bg-white border-4 border-border p-8 md:p-12 mb-8">
        ...
        <p className="text-sm text-muted-foreground mb-6">
          Click the expand icon to open a fullscreen lightbox. Press Escape or click outside to
          close.
        </p>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          ...
          <div className="relative overflow-hidden border-2 border-border">
            ...
            <div className="absolute bottom-0 left-0 right-0 p-6">
              ...
              <h4 className="font-display text-xl font-bold uppercase text-background">
                Dutch Architecture
              </h4>
          ...
          <div className="relative overflow-hidden border-2 border-border group cursor-pointer">
            ...
            <div className="absolute inset-0 bg-foreground/0 group-hover:bg-foreground/70 transition-colors duration-300 flex items-center justify-center">
              <div className="text-center opacity-0 group-hover:opacity-100 transition-opacity duration-300">
                <h4 className="font-display text-2xl font-bold uppercase text-background mb-2">
                  View Project
                </h4>
          ...
          {[
            {
              ...
              tag: 'Architecture',
              title: 'Project Alpha',
              desc: 'Structural design with bold geometry and open space planning.',
            },
            {
              seed: 'card2',
              tag: 'Interior',
              title: 'Project Beta',
              desc: 'Minimalist interiors blending warmth and precision in every detail.',
            },
            {
              seed: 'card3',
              tag: 'Landscape',
              title: 'Project Gamma',
              desc: 'Outdoor spaces shaped by natural forms and Dutch heritage.',
            },
          ].map((item) => (
          ...
          <div className="absolute inset-0 bg-gradient-to-r from-foreground/80 to-transparent flex items-end p-8">
            <div>
              ...
              <p className="text-background/70 max-w-md">
                Zero border radius, strong borders, and warm Dutch-inspired color palettes.
              </p>
            </div>
          </div>
          <button
