  ...
  return (
    <Layout
      ...
      meta={{
        ...
        keywords: 'Bun, JSX, SSR, server-side rendering, design system, Dutch design, Tailwind CSS',
      }}
        ...
        <div className="container mx-auto px-4 md:px-6">
          <div className="max-w-4xl">
            ...
            <div className="flex flex-wrap gap-4">
              <a
                href="https://github.com/skitsanos/dutchy-design-system/tree/main/docs/03-using-with-bun"
                className="bg-primary text-primary-foreground px-8 py-4 font-bold uppercase tracking-wide hover:bg-primary/90 transition-colors inline-flex items-center gap-2"
              >
                Full Documentation
                <svg
              ...
              <a
                href="https://github.com/skitsanos/dutchy-design-system/tree/main/src/utils/loadRoutes.ts"
                className="border-2 border-foreground px-8 py-4 font-bold uppercase tracking-wide hover:bg-foreground hover:text-background transition-colors"
              >
                View Source
              </a>
            </div>
          ...
          <div className="flex items-start gap-6">
            ...
            <div>
              ...
              <p className="text-background/80 leading-relaxed max-w-3xl">
                <strong>These are NOT traditional React components.</strong> Bun's SSR renders JSX
                to static HTML on the server - there is no React runtime on the client. No{' '}
                <code className="bg-background/20 px-2 py-0.5">useState</code>, no{' '}
                <code className="bg-background/20 px-2 py-0.5">useEffect</code>, no client-side
                hydration. For interactivity, use vanilla JavaScript.
              </p>
            </div>
          </div>
        </div>
        ...
        <div className="container mx-auto px-4 md:px-6">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
            ...
            <div className="border-2 border-border p-8">
              ...
              <pre className="bg-foreground text-background p-6 text-sm overflow-x-auto">
                <code>{`mkdir my-dutchy-app
cd my-dutchy-app
bun init -y
...
console.log('Server running at http://localhost:3000');`}</code>
              </pre>
            </div>
          </div>
        </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-0.5 bg-border">
            ...
            <div className="bg-background p-8">
              ...
              <p className="text-muted-foreground mb-6 text-sm leading-relaxed">
                Native <code className="bg-muted px-2 py-0.5">routes</code> option in Bun.serve().
                Simplest approach for quick prototypes.
              </p>
              <pre className="bg-foreground text-background p-4 text-xs overflow-x-auto mb-6">
                <code>{`serve({
  routes: {
    '/': HomePage,
    '/users/:id': handler,
    '/api/*': notFound,
              ...
              <div className="text-sm">
                ...
                <code className="bg-muted px-2 py-0.5">req.params.id</code>
              </div>
            </div>
            ...
            <div className="bg-background p-8">
              ...
              <p className="text-muted-foreground mb-6 text-sm leading-relaxed">
                Bun's <code className="bg-muted px-2 py-0.5">FileSystemRouter</code> class with
...
└── blog/
    └── [slug].tsx → /blog/:slug`}</code>
              ...
              <div className="text-sm">
                <span className="font-bold">Params:</span>{' '}
                <code className="bg-muted px-2 py-0.5">match.params</code>
              </div>
            </div>
...
│       └── put.ts → PUT`}</code>
              ...
              <div className="text-sm">
                <span className="font-bold">Params:</span>{' '}
                <code className="bg-muted px-2 py-0.5">_param_id</code>
              </div>
            </div>
          </div>
        </div>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
            ...
            <div>
              <h3 className="font-display text-xl font-bold uppercase mb-6 flex items-center gap-3">
                <span className="w-8 h-8 bg-foreground text-background flex items-center justify-center text-sm">
                  1
                </span>
    ...
    card.addEventListener('click', () => {
      ...
      <section className="py-20">
        <div className="container mx-auto px-4 md:px-6">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
            <pre className="bg-foreground text-background p-8 text-sm overflow-x-auto">
              <code>{`my-dutchy-app/
├── src/
            ...
            <div className="space-y-6">
              <div className="border-l-4 border-primary pl-6">
                ...
                <p className="text-muted-foreground text-sm">
                  File-based routing. Filename determines HTTP method:{' '}
                  <code className="bg-muted px-2 py-0.5">index.tsx</code> = GET,{' '}
                  <code className="bg-muted px-2 py-0.5">post.ts</code> = POST
                </p>
              </div>
              ...
              <div className="border-l-4 border-border pl-6">
                ...
                <p className="text-muted-foreground text-sm">
                  Utilities like <code className="bg-muted px-2 py-0.5">loadRoutes.ts</code> for
              ...
              <div className="border-l-4 border-border pl-6">
                ...
                <p className="text-muted-foreground text-sm">
                  Dynamic route segments. <code className="bg-muted px-2 py-0.5">$id</code> becomes{' '}
                  <code className="bg-muted px-2 py-0.5">:id</code> in the URL pattern.
                </p>
              </div>
            </div>
          </div>
      ...
      <section className="py-20 bg-primary">
        <div className="container mx-auto px-4 md:px-6 text-center">
          ...
          <p className="text-primary-foreground/80 max-w-xl mx-auto mb-8 text-lg">
            Complete documentation with examples for routing, components, forms, API routes, and
            more.
          </p>
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            <a
              href="https://github.com/skitsanos/dutchy-design-system/tree/main/docs/03-using-with-bun"
              className="bg-foreground text-background px-8 py-4 font-bold uppercase tracking-wider hover:bg-foreground/90 transition-colors inline-flex items-center justify-center gap-2"
            >
              <svg
                xmlns="http://www.w3.org/2000/svg"
                width="20"
            ...
            <a
              ...
              className="bg-primary-foreground text-primary px-8 py-4 font-bold uppercase tracking-wider hover:bg-primary-foreground/90 transition-colors inline-flex items-center justify-center gap-2"
            >
              <svg
                xmlns="http://www.w3.org/2000/svg"
                width="20"
