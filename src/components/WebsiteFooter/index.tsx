      ...
      <div className="container mx-auto px-4 md:px-6">
        <div className="grid grid-cols-1 md:grid-cols-12 gap-12 mb-20">
          <div className="md:col-span-4 space-y-6">
            ...
            <p className="text-background/60 text-sm max-w-xs">
              A bold, structural design system inspired by Dutch design principles. Zero border
              radius, warm colors, architectural layouts.
            </p>
          </div>

          <div className="md:col-span-2 md:col-start-7">
            <h4 className="font-display font-bold uppercase tracking-widest mb-6 text-primary">
              Foundations
            </h4>
            <ul className="space-y-4 font-medium">
              ...
              <li>
                <a href="/colors" className="hover:text-primary transition-colors">
                  Colors
                </a>
              </li>
              <li>
          ...
          <div className="md:col-span-2">
            ...
            <ul className="space-y-4 font-medium">
              <li>
                <a href="/bun" className="hover:text-primary transition-colors">
                  Using with Bun
                </a>
              </li>
              <li>
                <a href="/patterns" className="hover:text-primary transition-colors">
                  Patterns
                </a>
              </li>
              <li>
        ...
        <div className="border-t border-background/20 pt-8 flex flex-col md:flex-row justify-between items-center gap-6">
          ...
          <div className="flex gap-6">
            ...
            <a
              href="https://www.linkedin.com/in/skitsanos/"
              className="w-8 h-8 bg-background text-foreground flex items-center justify-center hover:bg-primary hover:text-primary-foreground transition-colors"
              aria-label="LinkedIn"
            >
              <svg
