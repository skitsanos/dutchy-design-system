          ...
          <div className="flex flex-col justify-center p-8 md:p-16 lg:p-20 bg-background relative overflow-hidden">
            ...
            <div className="relative z-10">
              ...
              <p className="text-xl md:text-2xl font-medium text-muted-foreground mb-12 max-w-md leading-tight">
                The definitive design system for building bold, structural interfaces with
                Dutch-inspired aesthetics.
              </p>
              ...
              <div className="flex flex-wrap gap-4">
                ...
                <a
                  href="/typography"
                  className="border-2 border-foreground text-foreground px-8 py-4 font-bold uppercase tracking-wide hover:bg-foreground hover:text-background transition-colors"
                >
                  View Typography
                </a>
              </div>
              ...
              <div className="mt-12 flex gap-4 font-mono text-xs uppercase tracking-wider text-muted-foreground">
                ...
                <a href="/colors" className="hover:text-foreground hover:underline">
                  Colors
                </a>
                <a href="/components" className="hover:text-foreground hover:underline">
                  Forms
                </a>
                <a href="/patterns" className="hover:text-foreground hover:underline">
                  Patterns
                </a>
              </div>
            </div>
          ...
          <div className="bg-muted relative flex flex-col">
            ...
            <div className="flex-1 bg-foreground p-12 flex items-end">
              <div className="text-background">
                ...
                <h3 className="font-display text-4xl font-bold uppercase tracking-tight mb-2">
                  50+
                </h3>
            ...
            <div className="flex-1 grid grid-cols-2">
              <a
                href="/components"
                className="bg-primary p-8 flex flex-col justify-between hover:bg-primary/90 transition-colors cursor-pointer group border-r border-background/20"
              >
                <svg
                  xmlns="http://www.w3.org/2000/svg"
                  width="32"
                  ...
                  strokeLinecap="round"
                  strokeLinejoin="round"
                  className="text-primary-foreground group-hover:translate-x-1 group-hover:-translate-y-1 transition-transform"
                >
                  <path d="M7 7h10v10" />
                  <path d="M7 17 17 7" />
                </svg>
              ...
              <a
                href="/typography"
                className="bg-background p-8 flex flex-col justify-between border-t border-border hover:bg-muted transition-colors cursor-pointer group"
              >
                <svg
                  xmlns="http://www.w3.org/2000/svg"
                  width="32"
      ...
      <section className="py-24 bg-muted/30">
        <div className="container mx-auto px-4 md:px-6">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-0.5 bg-border border border-border">
            ...
            <a
              href="/typography"
              className="bg-background p-6 hover:bg-white transition-colors group block"
            >
              ...
              <h3 className="font-display text-2xl font-bold uppercase leading-none mb-2 group-hover:text-primary transition-colors">
                Typography
              </h3>
            ...
            >
              ...
              <div className="mb-6">
                ...
                >
                  ...
                  <path d="M12 22c3.5-3.5 6-6.5 6-10a6 6 0 0 0-12 0c0 3.5 2.5 6.5 6 10z" />
                </svg>
              </div>
              <h3 className="font-display text-2xl font-bold uppercase leading-none mb-2 group-hover:text-primary transition-colors">
                Colors
              ...
              <p className="text-sm font-medium text-muted-foreground mb-4">
                Palette, semantic colors, and usage
              </p>
              <div className="mt-auto pt-4 border-t border-border/50 flex gap-2">
                <span className="text-xs font-mono uppercase bg-muted px-2 py-1">Tokens</span>
              </div>
            ...
            >
              ...
              <p className="text-sm font-medium text-muted-foreground mb-4">
                Hero, navigation, footer layouts
              </p>
              <div className="mt-auto pt-4 border-t border-border/50 flex gap-2">
      ...
      <section className="py-20 bg-primary">
        <div className="container mx-auto px-4 md:px-6 text-center">
          ...
          <p className="text-primary-foreground/80 max-w-xl mx-auto mb-8 text-lg">
            Dutchy is open source and free to use. Clone the repo and start creating bold,
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            ...
            <a
              href="/components"
              className="bg-primary-foreground text-primary px-8 py-4 font-bold uppercase tracking-wider hover:bg-primary-foreground/90 transition-colors"
            >
              Browse Components
            </a>
          </div>
