          ...
          <div>
            ...
            <Flex align="stretch" gap={3} className="h-24 bg-muted/50 border-2 border-border p-3">
              <Flex
                align="center"
                justify="center"
                className="bg-foreground text-background px-4 text-sm font-bold"
              >
                A
              </Flex>
              <Flex
        ...
        <div className="space-y-6">
          {([0, 1, 2, 4, 6, 8] as const).map((g) => (
            <div key={g}>
              ...
              <Flex gap={g}>
                <div className="bg-foreground text-background w-12 h-12 flex items-center justify-center text-sm font-bold">
                  {g}
                </div>
                <div className="bg-foreground text-background w-12 h-12 flex items-center justify-center text-sm font-bold">
                  {g}
      ...
      <div className="bg-background border-4 border-border p-8 md:p-12 mb-8">
        ...
        <Flex wrap gap={3}>
          {Array.from({ length: 12 }, (_, i) => (
            <div
              key={i}
              className="bg-primary text-primary-foreground px-6 py-3 text-sm font-bold uppercase"
            >
              Item {i + 1}
            </div>
          ))}
        ...
        <div className="space-y-6">
          ...
          <div>
            ...
            <Flex
              ...
              direction="col"
              gap={2}
              className="bg-muted/50 border-2 border-border p-4 list-none"
            >
        ...
        <div className="space-y-8">
            ...
            <Flex gap={4} align="start" className="border-2 border-border p-4">
              ...
              <div className="min-w-0">
                ...
                <p className="text-sm text-muted-foreground mt-1">
                  You have 3 unread messages in your inbox. Check them before they expire.
                </p>
              </div>
            </Flex>
          </div>
          ...
          <div>
            ...
            <Flex
              ...
              align="center"
              justify="center"
              className="h-48 bg-muted/50 border-2 border-dashed border-border"
            >
          ...
          <table className="w-full text-sm">
            <thead>
              <tr className="bg-muted border-b-2 border-border">
                <th className="text-left px-4 py-3 font-display font-bold uppercase text-xs tracking-wider">
                  Prop
                </th>
                <th className="text-left px-4 py-3 font-display font-bold uppercase text-xs tracking-wider">
                  Type
            ...
            <tbody className="divide-y divide-border">
              <tr>
                <td className="px-4 py-3 font-mono font-bold text-xs">direction</td>
              ...
              <tr className="bg-muted/30">
                <td className="px-4 py-3 font-mono font-bold text-xs">align</td>
                <td className="px-4 py-3 font-mono text-xs text-muted-foreground">
              ...
              <tr>
                <td className="px-4 py-3 font-mono font-bold text-xs">justify</td>
                <td className="px-4 py-3 font-mono text-xs text-muted-foreground">
              ...
              <tr className="bg-muted/30">
                <td className="px-4 py-3 font-mono font-bold text-xs">wrap</td>
              ...
              <tr>
                <td className="px-4 py-3 font-mono font-bold text-xs">gap</td>
                <td className="px-4 py-3 font-mono text-xs text-muted-foreground">
              ...
              <tr className="bg-muted/30">
                <td className="px-4 py-3 font-mono font-bold text-xs">as</td>
                <td className="px-4 py-3 font-mono text-xs text-muted-foreground">ElementType</td>
                <td className="px-4 py-3 font-mono text-xs">"div"</td>
              </tr>
            </tbody>
          </table>
        </div>
