  ...
  <ComponentPageLayout componentId="modals">
    <>
      <Flex wrap gap={4} className="mb-8">
        ...
        <Button variant="secondary" data-open-modal="content-modal">
          Content Modal
        </Button>
        <Button variant="outline" data-open-modal="drawer">
          Right Drawer
        </Button>
      </Flex>
      ...
      <Drawer id="drawer" title="Details">
        <div className="space-y-4">
          <div>
            <p className="font-display font-bold uppercase text-xs tracking-wider text-muted-foreground">
              Status
            </p>
