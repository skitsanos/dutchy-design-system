      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
        ...
        <Card variant="accent" padding="sm">
          ...
          <p className="text-muted-foreground text-sm">
            Highlight key features with an icon and accent border.
          </p>
        </Card>
        ...
        >
          ...
          <h3 className="font-display font-bold uppercase mb-2 group-hover:text-primary transition-colors">
            Clickable Card
          </h3>
          <p className="text-muted-foreground text-sm">
            Entire card is interactive with hover effects.
          </p>
        </a>
      ...
      <div className="mt-8 bg-white border-4 border-border p-8 md:p-12">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
          ...
          <Card variant="bordered" padding="none">
            <Image
              src="https://picsum.photos/seed/card-img1/400/250"
            ...
            <div className="p-5 border-t-2 border-border">
              ...
              <p className="text-sm text-muted-foreground mb-4">
                Explore scenic routes through alpine landscapes and hidden valleys.
              </p>
              <a
                href="#"
                className="text-primary font-bold uppercase text-sm hover:underline inline-flex items-center gap-1"
              >
                Read more
          ...
          <Card variant="bordered" padding="none">
            <div className="relative">
              <Image
                src="https://picsum.photos/seed/card-img2/400/250"
                alt="City skyline"
                height="h-48"
              />
            ...
            <div className="p-5 border-t-2 border-border">
              ...
              <p className="text-sm text-muted-foreground mb-4">
                Modern cities shaped by functional aesthetics and bold vision.
              </p>
              <Flex gap={2}>
          ...
          <Card variant="bordered" padding="none" className="flex flex-col">
            <Image
              src="https://picsum.photos/seed/card-img3/400/250"
              alt="Workshop"
              height="h-48"
            />
            <div className="p-5 border-t-2 border-border flex-grow">
              ...
              <p className="text-sm text-muted-foreground">
                Hands-on sessions exploring traditional and modern craft techniques.
              </p>
            </div>
        ...
        <Card variant="bordered" padding="none" className="mt-6 grid grid-cols-1 md:grid-cols-12">
          <div className="md:col-span-4">
            <Image
              src="https://picsum.photos/seed/card-horiz/400/300"
              alt="Exhibition"
              height="h-full"
          ...
          <Flex
            direction="col"
            justify="center"
            className="md:col-span-8 p-6 md:p-8 border-t-2 md:border-t-0 md:border-l-2 border-border"
          >
            <span className="font-mono text-[10px] font-bold text-primary uppercase tracking-wider mb-2">
              Exhibition
            </span>
            <h4 className="font-display text-xl font-bold uppercase mb-3">
              Dutch Masters Revisited
            </h4>
            <p className="text-sm text-muted-foreground mb-4">
              A contemporary take on classical Dutch art, blending centuries of tradition with bold
              modern forms.
            </p>
            <div>
              <Button>
