  ...
  <ComponentPageLayout componentId="menu">
    <>
      ...
      <div className="bg-background border-4 border-border p-8 md:p-12 mb-8">
        ...
        <Menu width="sm">
          <MenuItem icon={<Icon name="copy" size="sm" />} shortcut="Ctrl+C">
            Copy
          </MenuItem>
          <MenuItem icon={<Icon name="edit" size="sm" />} shortcut="Ctrl+V">
            Paste
          </MenuItem>
          <MenuItem icon={<Icon name="search" size="sm" />} shortcut="Ctrl+F">
            Find
          </MenuItem>
          <MenuDivider />
          <MenuItem icon={<Icon name="settings" size="sm" />} shortcut="Ctrl+,">
            Settings
          </MenuItem>
        </Menu>
      </div>
      ...
      <div className="bg-background border-4 border-border p-8 md:p-12 mb-8">
        ...
        <Menu>
          ...
          <MenuDivider />
          <MenuItem variant="destructive" icon={<Icon name="trash" size="sm" />}>
            Delete
          </MenuItem>
        </Menu>
      </div>
      ...
      <div className="bg-background border-4 border-border p-8 md:p-12 mb-8">
        ...
        <Flex gap={6} wrap>
          <Dropdown
            trigger={
              <Button
                variant="outline"
                size="sm"
                className="px-6 border-border hover:border-foreground"
              >
                File
            ...
            width="min-w-[220px]"
          >
            <MenuItem icon={<Icon name="file" size="sm" />} shortcut="Ctrl+N">
              New
            </MenuItem>
            <MenuItem icon={<Icon name="folder" size="sm" />} shortcut="Ctrl+O">
              Open
            </MenuItem>
            <MenuItem icon={<Icon name="save" size="sm" />} shortcut="Ctrl+S">
              Save
            </MenuItem>
            <MenuDivider />
          ...
          >
            ...
            <MenuDivider />
            <MenuItem variant="destructive" icon={<Icon name="trash" size="sm" />} shortcut="Del">
              Delete
            </MenuItem>
          </Dropdown>
        </Flex>
      ...
      <div className="bg-background border-4 border-border p-8 md:p-12 mb-8">
        ...
        <Menu width="sm">
          ...
          <MenuDivider />
          <MenuItem variant="destructive" icon={<Icon name="logout" size="sm" />}>
            Sign Out
          </MenuItem>
        </Menu>
      </div>
        ...
        <div className="overflow-x-auto">
          <table className="w-full text-sm">
            ...
            <tbody className="divide-y divide-border">
              <tr>
                <td className="px-4 py-3 font-mono font-bold text-xs">Menu</td>
                <td className="px-4 py-3 font-mono text-xs">width</td>
                <td className="px-4 py-3 font-mono text-xs text-muted-foreground">
                  "xs" | "sm" | "md"
                </td>
                <td className="px-4 py-3 font-mono text-xs">"xs"</td>
              </tr>
              <tr className="bg-muted/30">
                <td className="px-4 py-3 font-mono font-bold text-xs">MenuItem</td>
              ...
              <tr>
                <td className="px-4 py-3 font-mono font-bold text-xs">MenuGroup</td>
