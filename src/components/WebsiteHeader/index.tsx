    ...
    <header className="w-full border-b-4 border-primary bg-background sticky top-0 z-50">
      <div className="container mx-auto px-4 md:px-6 h-20 flex items-center justify-between">
        <a href="/" className="flex items-center gap-3">
          ...
          <span className="font-display font-bold text-2xl tracking-tighter uppercase">Dutchy</span>
        </a>
        ...
        <button type="button" className="md:hidden p-2" aria-label="Menu" id="mobile-menu-btn">
          <svg
            xmlns="http://www.w3.org/2000/svg"
            width="24"
            height="24"
