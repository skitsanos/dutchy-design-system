...
const ComponentsPage: FC = () => {
  ...
  return (
    <Layout
      ...
      meta={{
        description:
          'UI Components for Dutchy Design System. Buttons, forms, cards, navigation and more with zero border radius.',
        keywords:
          'UI components, buttons, forms, cards, badges, alerts, design system, Tailwind CSS',
      }}
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-end">
            <div>
              ...
              <p className="text-xl text-muted-foreground max-w-lg leading-relaxed">
                Building blocks for bold interfaces. All components feature zero border radius,
                strong borders, and the distinctive Dutchy aesthetic.
              </p>
            </div>
