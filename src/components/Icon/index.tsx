...
const icons: Record<IconName, { paths: string[]; viewBox?: string; filled?: boolean }> = {
  ...
  quote: {
    paths: [
      'M3 4h5v5H3v2c0 2 1.5 3.5 3.5 3.5v2C3.5 16.5 1 14 1 10.5V4z',
      'M15 4h5v5h-5v2c0 2 1.5 3.5 3.5 3.5v2c-3 0-5.5-2.5-5.5-6V4z',
    ],
  },
  users: {
    paths: [
  ...
  bot: {
    paths: [
      'M12 2a2 2 0 012 2v1h3a2 2 0 012 2v10a2 2 0 01-2 2H7a2 2 0 01-2-2V7a2 2 0 012-2h3V4a2 2 0 012-2z',
      'M9 12a1 1 0 100-2 1 1 0 000 2z',
      'M15 12a1 1 0 100-2 1 1 0 000 2z',
      'M9 16h6',
    ],
  },
  workflow: {
    paths: [
      'M3 6a3 3 0 116 0 3 3 0 01-6 0z',
      'M15 6a3 3 0 116 0 3 3 0 01-6 0z',
      'M9 18a3 3 0 116 0 3 3 0 01-6 0z',
      'M6 9v3a3 3 0 003 3h0',
      'M18 9v3a3 3 0 01-3 3h0',
    ],
  },
  dna: {
    viewBox: '0 0 512 512',
  ...
  archive: {
    paths: [
      'M5 8h14M5 8a2 2 0 01-2-2V4a2 2 0 012-2h14a2 2 0 012 2v2a2 2 0 01-2 2M5 8v10a2 2 0 002 2h10a2 2 0 002-2V8',
      'M10 12h4',
    ],
  },
};
