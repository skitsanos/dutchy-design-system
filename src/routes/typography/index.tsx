        ...
        <div className="container mx-auto px-4 md:px-6">
          <div className="max-w-3xl">
            ...
            <p className="text-xl text-muted-foreground leading-relaxed">
              The Dutchy type system uses three carefully selected font families: Space Grotesk for
              bold display text, Inter for readable body copy, and JetBrains Mono for code.
            </p>
          </div>
        </div>
      </section>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-0.5 bg-border">
            ...
            <div className="bg-background p-8">
              ...
              <p className="text-muted-foreground mb-6">
                Used for headlines, titles, and any text that needs to make an impact. Bold weights
                only.
              </p>
            ...
            <div className="bg-background p-8">
              ...
              <p className="font-sans text-5xl font-semibold mb-4">Inter</p>
              <p className="text-muted-foreground mb-6">
                The workhorse font for body text, UI elements, and anything that needs to be highly
                readable.
              </p>
              <div className="font-mono text-xs bg-foreground text-background p-4">
                font-family: 'Inter'
            ...
            <div className="bg-background p-8">
              ...
              <p className="font-mono text-4xl font-bold mb-4">JetBrains Mono</p>
              <p className="text-muted-foreground mb-6">
      ...
      <section className="py-16 border-b border-border bg-muted/30">
        <div className="container mx-auto px-4 md:px-6">
          ...
          <p className="text-muted-foreground mb-12 max-w-2xl">
            A carefully crafted scale that provides clear visual hierarchy. Display sizes use Space
            Grotesk, body sizes use Inter.
          </p>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            ...
            <div className="bg-foreground text-background p-8">
              ...
              <p className="text-background/70 text-sm">
                Used for hero headlines and major section titles. Always uppercase with tight
                letter-spacing.
              </p>
            </div>
            ...
            <div className="bg-background border-4 border-border p-8">
              ...
              <p className="text-base mt-4 mb-6 leading-relaxed">
                Body text uses Inter at regular weight with relaxed line height for optimal
                readability. This creates comfortable reading for longer content blocks.
              </p>
              <p className="text-muted-foreground text-sm">
        ...
        <div className="container mx-auto px-4 md:px-6">
          ...
          <div className="max-w-3xl bg-background p-8 md:p-12 border-l-4 border-primary">
            ...
            <p className="text-xl text-muted-foreground mb-8 leading-relaxed">
              Dutch design is characterized by its bold simplicity, structural clarity, and
              functional beauty. It rejects unnecessary ornamentation in favor of honest expression.
            </p>
            ...
            <p className="text-base leading-relaxed mb-6">
              The foundation of Dutch design lies in its commitment to clarity and purpose. Every
              element must justify its existence. This philosophy extends from architecture to
              graphic design, creating a cohesive visual language that speaks through structure
              rather than decoration.
            </p>

            <p className="text-base leading-relaxed mb-6">
              Sharp corners and clean edges define the aesthetic. The deliberate absence of rounded
              corners creates a bold, architectural feel that demands attention without shouting.
              It's confident design that knows its worth.
            </p>

            <h3 className="font-display text-xl font-bold uppercase mb-3">Color as Structure</h3>

            <p className="text-base leading-relaxed mb-6">
              Colors in Dutch design serve structural purposes. The warm orange primary creates
              focal points, while the neutral palette provides a stable foundation. Each color has a
              role, a purpose, a place in the hierarchy.
            </p>
            ...
            <p className="text-base leading-relaxed">
              This philosophy permeates every aspect of the Dutchy Design System. From typography
              choices to spacing scales, each decision reinforces the core values of bold simplicity
