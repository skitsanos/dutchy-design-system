        ...
        <div className="container mx-auto px-4 md:px-6">
          <div className="max-w-3xl">
            ...
            <p className="text-xl text-muted-foreground leading-relaxed">
              Pre-built layout patterns for common UI sections. Hero areas, navigation bars,
              footers, and grid layouts with the Dutchy aesthetic.
            </p>
          </div>
        </div>
      </section>
              ...
              <div className="grid grid-cols-1 lg:grid-cols-2 min-h-[400px]">
                <div className="flex flex-col justify-center p-8 md:p-12 bg-background relative">
                  ...
                  <div className="flex gap-4">
                    <button
                      type="button"
                      className="bg-primary text-primary-foreground px-6 py-3 font-bold uppercase tracking-wide text-sm"
                    >
                      Primary CTA
                    </button>
                    <button
                      type="button"
                      className="border-2 border-foreground px-6 py-3 font-bold uppercase tracking-wide text-sm"
                    >
                      Secondary
                    </button>
                  </div>
          ...
          <div className="mb-12">
            ...
            <div className="border-4 border-border bg-background py-16 px-8 text-center">
              <div className="max-w-3xl mx-auto">
                ...
                <button
                  type="button"
                  className="bg-primary text-primary-foreground px-8 py-4 font-bold uppercase tracking-wide"
                >
                  Get Started
                </button>
              </div>
            ...
            <div className="border-4 border-border overflow-hidden">
              <div className="bg-foreground text-background p-8 md:p-12">
                <div className="max-w-2xl">
                  ...
                  <p className="text-background/70 mb-8">Let your metrics make the impact.</p>
                </div>
              </div>
              ...
              <header className="w-full border-b-4 border-primary bg-background">
                <div className="px-6 h-20 flex items-center justify-between">
                  ...
                  <nav className="hidden md:flex items-center gap-8">
                    <a
                      href="#"
                      className="text-sm font-bold uppercase tracking-widest text-primary underline decoration-4 underline-offset-4"
                    >
                      Home
                    </a>
                    <a
                    ...
                    <a
                      href="#"
                      className="bg-primary text-primary-foreground font-bold uppercase tracking-wide px-6 py-3"
                    >
                      Get Started
                    </a>
                  </nav>
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
              <div className="border-l-4 border-primary bg-background p-6">
                ...
                <p className="text-sm text-muted-foreground">
                  Description of the first feature with supporting details.
                </p>
              </div>
              <div className="border-l-4 border-primary bg-background p-6">
                <div className="w-12 h-12 bg-primary/10 flex items-center justify-center mb-4">
                ...
                <p className="text-sm text-muted-foreground">
                  Description of the second feature with supporting details.
                </p>
              </div>
              <div className="border-l-4 border-primary bg-background p-6">
                <div className="w-12 h-12 bg-primary/10 flex items-center justify-center mb-4">
                ...
                <p className="text-sm text-muted-foreground">
                  Description of the third feature with supporting details.
                </p>
              </div>
            </div>
          </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-12 gap-0.5 bg-border">
              <div className="md:col-span-8 bg-foreground text-background p-8">
                ...
                <p className="text-background/70">
                  Larger area for primary content or featured items.
                </p>
              </div>
              ...
              <div className="px-6 md:px-8">
                <div className="grid grid-cols-1 md:grid-cols-12 gap-8 md:gap-12 mb-16">
                  ...
                  <div className="md:col-span-2 md:col-start-7">
                    <h4 className="font-display font-bold uppercase tracking-widest mb-4 text-primary text-sm">
                      Products
                    </h4>
                ...
                <div className="border-t border-background/20 pt-6 flex flex-col md:flex-row justify-between items-center gap-4">
                  ...
                  <div className="flex gap-4">
                    <a
                      href="#"
                      className="w-8 h-8 bg-background text-foreground flex items-center justify-center hover:bg-primary hover:text-primary-foreground transition-colors"
                    >
                      <svg
                        xmlns="http://www.w3.org/2000/svg"
                        width="16"
          ...
          <div className="border-4 border-border overflow-hidden bg-primary py-16 px-8 text-center">
            <div className="max-w-2xl mx-auto">
              ...
              <div className="flex flex-col sm:flex-row gap-4 justify-center">
                <button
                  type="button"
                  className="bg-foreground text-background px-8 py-4 font-bold uppercase tracking-wide"
                >
                  Start Free Trial
                </button>
                <button
                  type="button"
                  className="bg-primary-foreground text-primary px-8 py-4 font-bold uppercase tracking-wide"
                >
                  View Documentation
                </button>
              </div>
